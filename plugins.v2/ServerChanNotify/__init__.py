...
class ServerChanNotify(_PluginBase):
    ...
    def get_dashboard_meta(self) -> Optional[List[Dict[str, str]]]:
        ...
        return [
            {
                "key": "SilentReed_serverchan_dashboard",
                "name": "Server酱通知插件仪表盘"
            }
        ]
    ...
    def get_dashboard(self, key: str, **kwargs) -> Optional[Tuple[Dict[str, Any], Dict[str, Any], List[dict]]]:
        ...
        获取插件仪表盘页面
        """
        if key == "SilentReed_serverchan_dashboard":
            col_config = {
                "cols": 12, "md": 6
            }
            global_config = {
            ...
            page_config = [
                {
                    ...
                    "props": {
                        "title": "Server酱通知插件",
                        "text": "这是 Server 酱通知插件的仪表盘"
                    }
                }
            ]
            return col_config, global_config, page_config
        return None
